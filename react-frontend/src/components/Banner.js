...
const Banner = ({obj}) => {
 console.log("Link obj  inside Banner",obj)
      ...
      <div
          ...
          >
              ...
              <div className="rounded-full border-8 border-primary shadow-xl">
                <img
                  src="/assets/img/Nur-final.jpg"
                  // src="/assets/img/nur-nur.jpeg"
              ...
              <div className="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
                ...
                >
                  ...
                  >
                    ...
                    <a href={obj.github} target="_blank" className="pl-4">
                      <i
                        className="bx bxl-github text-2xl text-white hover:text-yellow"
                      ></i>
                    </a>
                    <a href={obj.linkedin} target="_blank" className="pl-4">
                      <i
                        className="bx bxl-linkedin text-2xl text-white hover:text-yellow"
                      ></i>
                    </a>
                    <a href={obj.instagram} target="_blank" className="pl-4">
                      <i
